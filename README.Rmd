...
+=================================+====================================================================================================================================================================+=============+
| **Future**                      | 1.Climate, river inputs, fishing -- high res                                                                                                                       | **obsclim** |
|                                 |                                                                                                                                                                    |             |
...
+---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+
|                                 | 2.Climate, river inputs, no fishing -- high res                                                                                                                    | **obsclim** |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **CF:**  same as above using **0.25 degree grid**                                                                                                              | **nat**     |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **DHF:** without any fishing activity (nat)                                                                                                                    |             |
+---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+
| **Riverine influx sensitivity** | 3.Climate, no river input forcing, fishing -- high res                                                                                                             | **obsclim** |
|                                 |                                                                                                                                                                    |             |
...
|                                 | -   **DHF:** Varying direct human influences according to observed reconstructed fishing effort time series (histsoc).                                             |             |
+---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+
|                                 | 4.Climate, no river input forcing, no fishing -- high res                                                                                                          | **obsclim** |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **CF:**  same as above using **0.25 degree grid**                                                                                                              | **nat**     |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **DHF:** without any fishing activity (nat)                                                                                                                    |             |
+---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+
| **Resolution sensitivity test** | 5.Climate, river input forcing, fishing -- low res                                                                                                                 | **obsclim** |
|                                 |                                                                                                                                                                    |             |
...
|                                 | -   **DHF:** Varying direct human influences according to observed reconstructed fishing effort time series (histsoc).                                             |             |
+---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+
|                                 | 6.Climate, river input forcing, no fishing -- low res                                                                                                              | **obsclim** |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **CF**:  same as above using **1 degree grid**                                                                                                                 | **nat**     |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **DHF:** without any fishing activity (nat)                                                                                                                    |             |
+---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+
| **Control sensitivity test**    | 7.Climate, river input forcing, fishing -- low res                                                                                                                 | **obsclim** |
|                                 |                                                                                                                                                                    |             |
| 2 optional runs                 | -   **CF:** Climate variability constrained by reanalysis atmospheric forcing (GFDL-COBALT2 forced by JRA-55 and river inputs **obsclim**) using **1 degree grid** | **histsoc** |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **DHF:** Varying direct human influences according to observed reconstructed fishing effort time series (histsoc).                                             |             |
+---------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+
|                                 | 8.Climate, river input forcing, no fishing -- low res                                                                                                              | **obsclim** |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **CF**:  same as above using **1 degree grid**                                                                                                                 | **nat**     |
|                                 |                                                                                                                                                                    |             |
|                                 | -   **DHF:** without any fishing activity (nat)                                                                                                                    |             |
...
+------------+-------------+---------------------------------------------+------------+
| Title      | Specifiers  | Institution                                 | Original   |
|            |             |                                             | resolution |
+:===========+:============+:============================================+:===========+
| GFDLESM4   | gfdlesm4    | National Oceanic and Atmospheric            | 288x180    |
|            |             | Administration, Geophysical Fluid Dynamics  |            |
|            |             | Laboratory, Princeton, NJ 08540, USA        |            |
+------------+-------------+---------------------------------------------+------------+
| IPSLCM6ALR | ipslcm6a-lr | Institut Pierre Simon Laplace, Paris 75252, | 144x143    |
|            |             | France                                      |            |
+------------+-------------+---------------------------------------------+------------+
| OTHERS??   |             |                                             |            |
+------------+-------------+---------------------------------------------+------------+
